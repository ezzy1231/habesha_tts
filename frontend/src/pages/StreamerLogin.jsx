      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="glass-card rounded-2xl shadow-2xl p-8 space-y-6">
          ...
          <div className="text-center pt-4 border-t border-gray-100 dark:border-gray-700">
            <Link 
              to={`/streamer/${uuid}`} 
              className="inline-flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 transition-colors duration-200"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
